...
function simulatorScenarioResult(result){
  ...
  return `<article class="panel" style="margin-top:16px">
    ...
    <p style="color:var(--muted);font-size:12px;margin:12px 0 0">Ownership and existing Value evidence remain unchanged. State owns the hypothetical availability change; NEXT-4 Simulation owns competitive outcomes. Cache reuse is exact-result performance reuse only.</p>
  </article>`;
}
