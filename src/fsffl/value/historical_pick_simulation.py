...
from .historical_pick import HistoricalSlotProbability
from .historical_pick_evidence import HistoricalTeamDraftSlotForecast
...
def build_slot_forecast_from_draft_order(
    *,
    ...
    This adapter does not infer draft order, alter scenario probabilities, or
    calculate asset value. It only marginalizes the Simulation result for the
    pick's original team and preserves the upstream timestamp/version/provenance.
    """
