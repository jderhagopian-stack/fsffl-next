...
def test_live_corrective_busts_mobile_player_intelligence_cache() -> None:
    ...
    assert "player_intelligence.js?pi=20260922-player-intelligence-final-ia1&v=20260926-combined-acceptance1" in index
    assert "player_intelligence.css?pi=20260922-player-intelligence-final-ia1&v=20260926-combined-acceptance1" in index
