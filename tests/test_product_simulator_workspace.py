...
def test_simulator_is_first_class_team_scoped_product_route() -> None:
    ...
    assert "20260908-tradefinder4" in index
    assert '/static/simulator.js?v=20260908-tradefinder4' in index
    assert '/static/opportunities.js?v=20260908-tradefinder4' in index
    assert '/static/opportunity_spotlights.js?v=20260908-tradefinder4' in index
